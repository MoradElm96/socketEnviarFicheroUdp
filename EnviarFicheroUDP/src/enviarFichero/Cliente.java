...
public class Cliente {
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			...
			DatagramPacket paqueteEnviar = new DatagramPacket(enviar, enviar.length, direcion_servidor,
					puerto_Servidor);
			...
			String contenido = new String(paqueteRecibido.getData()).trim();

			if (contenido.equals("404: File not found")) {
				System.out.println(contenido);
				System.out.println("Escribe bien el nombre del fichero o ruta!");
